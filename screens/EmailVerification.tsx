...
const EmailVerification = ({navigation}) => {
    ...
    <MainContainer>
        <KeyboardAvoidingContainer>
            ...
            <IconHeader color={theme.accent} name="lock-open" style={{ marginBottom: 30}}/> 
            ...
            {!verifying && !pinReady && <RegularButton disabled={true} style={{backgroundColor: theme.secondary}} textStyle={{color: theme.lightGrey}}>Verify</RegularButton>}
